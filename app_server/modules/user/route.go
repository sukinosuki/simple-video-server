...
func SetupRoutes(v1 *gin.RouterGroup) {
	...
	// 优化toHandler
	v1.POST("/user/register", common.ToHandler(Api.RegisterHandler))

	v1.POST("/user/login", common.ToHandler(Api.Login))
	...
	{
		shouldAuth.GET("/user/profile", common.ToHandler(Api.Profile))
	}
}
